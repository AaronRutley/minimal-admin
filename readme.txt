...
- Hides the footer as well vairous outher minor css changes 

Once activated Minimal Admin does the following to the frontend for all users 
- The WordPress admin bar is hidden
